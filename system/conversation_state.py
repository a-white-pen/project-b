...
Food, attention, aligner, weight, and sleep/wake handlers write state for quoted corrections.
...
#   domain                          — domain string ("food", "attention", "aligner", "weight", "sleep_wake", etc.)
