...
Food, attention, aligner, expense, weight, and sleep/wake handlers write state for quoted corrections.
...
#   domain                          — domain string ("food", "attention", "aligner", "expense", "weight", "sleep_wake", etc.)
